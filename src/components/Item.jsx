...
const Item = ({ cart, item, addToCart, removeFromCart }) => {
  ...
  return (
    <div className="relative w-[100%]  sm:max-w-[260px] h-[340px] mx-auto sm:mx-0">
      <img
        ...
        } w-[100%] object-cover object-center h-[200px] rounded-lg mb-4`}
        src={image.desktop}
        alt={name}
      />
        ...
        <div className="">
          <div className="absolute left-[50%] translate-x-[-50%] bottom-[120px]">
            <Addbtn
              ...
              item={item}
              instance={cartData.length > 0 ? cartData[0].instances : 0}
            />
          </div>
        </div>
      </div>

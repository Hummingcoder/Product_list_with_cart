...
const Addbtn = ({ addToCart, item, removeFromCart, instance }) => {
    ...
    <button className="w-[140px]">
      ...
      >
        <span
          ...
          className=" hover:text-[#c83b0e] hover:bg-white border border-white rounded-full w-[20px] h-[20px]  text-white grid place-content-center pb-1 text-[20px] duration-200 active:scale-95"
        >
          -
        </span>

...
const Cart = ({ cart, removeItem, setCheckOutScreen }) => {
  ...
  return (
    <article className="w-full mx-auto max-w-[700px] xlg:max-w-[450px] bg-white p-8 rounded-lg">
      <p className=" text-2xl sm:text-3xl font-bold text-[#c83b0e] mb-6">
        Your Cart ({"0"})
      </p>
      <section>
        {cart.length < 1 ? (
          ...
          <div className="w-full flex flex-col items-start justify-center gap-8">
            ...
            <button
              ...
              className="w-full text-center p-4 bg-[#c83b0e] hover:bg-[#812304] duration-200 text-white font-bold text-xl rounded-full"
            >
              Confirm Order
            </button>
          </div>
